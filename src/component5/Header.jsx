...
const Header = ({ isCollapsed, setIsCollapsed }) => {
  ...
  <div className="flex items-center space-x-2">
        ...
        <div className="flex-1 flex justify-center w-full sm:w-auto mt-2 sm:mt-0">
          <div className="max-w-full sm:max-w-3xl md:max-w-[32rem] w-full">
            <div className="relative">
              <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" size={18} />
              <input
                type="text"
                placeholder="Search applicants, programs, etc..."
                className="w-full pl-9 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-colors text-xs sm:text-sm"
              />
            </div>
          </div>
        </div>
        ...
        <div className="relative mt-2 sm:mt-0">
          <div
            ...
            className="flex items-center space-x-2 sm:space-x-4 md:space-x-6 rounded-lg px-2 sm:px-4 py-2 sm:py-3 md:px-6 md:py-4 transition-colors cursor-pointer"
          >
            <img
              src={adminImage}
              alt="Admin profile"
            ...
            <div className="text-right">
              <p className="text-xs sm:text-sm font-medium text-gray-900 md:text-base">Princess</p>
          ...
          {isDropdownOpen && (
            <div className="absolute right-0 mt-2 w-40 sm:w-48 bg-white border border-gray-200 rounded-md shadow-lg z-10">
              <ul className="py-1 space-y-1">
                <li className="flex items-center px-3 sm:px-4 py-2 text-xs sm:text-sm text-gray-700 hover:bg-gray-100">
                ...
                <li className="flex items-center px-3 sm:px-4 py-2 text-xs sm:text-sm text-gray-700 hover:bg-gray-100 border-t border-gray-200">
