  ...
  const stepDetails = [
    {
      ...
      status: "Completed",
      style: "mt-1 sm:text-[8px] md:text-[10px] lg:text-xs text-[#0000FE] rounded-full px-1 lg:px-2 w-[100%] lg:w-[60%] text-center bg-[#CCCFFF]",
      style2: "bg-[#0000FE]",
    ...
    },
    {
      ...
      style2: progress > 40 ? "bg-[#0000FE]" : "bg-gray-200",
      borderColor: progress > 40 ? "border-[#0000FE]" : "border-gray-500",
    },
    {
      label: "STEP 4",
      ...
      status: "Not Started",
      style: "mt-1 sm:text-[8px] md:text-[10px] lg:text-xs text-gray-500 border border-gray-500 rounded-full px-1 lg:px-2 w-[80%] lg:w-[60%] text-center",
      style2: "bg-gray-200",
            ...
            <React.Fragment key={index}>
              ...
              <div className="flex flex-col items-center w-1/5">
                ...
                {index < stepDetails.length - 1 && (
                  <div className="w-full h-1 bg-gray-200 rounded-full relative mt-2">
                    <div
                      className={`h-full rounded-full ${step.style2}`}
                      style={{
                        width:
                          step.label === "STEP 1" || step.label === "STEP 2"
                            ? "100%"
                            : step.label === "STEP 3"
                            ? `${Math.max(0, Math.min(100, (progress - 40) * 5))}%`
                            : "0%",
                      }}
                    ></div>
                  </div>
                ...
                <span className="text-[8px] lg:text-[10px] xl:text-sm text-center text-gray-700">
                  {step.title}
                </span>
