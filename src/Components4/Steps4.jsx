...
const stepDetails = [
  ...
  { label: "STEP 4", title: "Write your Statement of Purpose", imagestep: number4Image, style: "mt-1 sm:text-[8px] md:text-[10px] lg:text-xs text-[#0000FE] border border-[#0000FE] rounded-full px-1 lg:px-2 w-[80%] lg:w-[60%] text-center", status: "In Progress" },
