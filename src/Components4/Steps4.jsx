...
const Steps4 = ({ progress, appStatus }) => {
  const adjustedProgress = appStatus === "In Progress" ? 80 : 70; // 70% default, 80% (70% + 10%) when SOP is written
  ...
  const stepDetails = [
    ...
    },
    {
      ...
      borderColor: appStatus === "In Progress" ? "border-[#0000FE]" : "border-gray-400",
      textStroke: appStatus === "In Progress" ? "#0000FE" : "gray",
      circleBackground: appStatus === "In Progress" ? "bg-#0000FE" : "transparent",
      progressFill: `${Math.min((progress - 75) * 5, 100)}%`, // Gradual fill for Step 4
    },
    {
      label: "STEP 5",
