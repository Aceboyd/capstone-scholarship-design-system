...
const Steps4 = ({ progress, appStatus }) => {
  const stepDetails = [
    ...
    },
    {
      ...
      style:
        progress > 75
          ? "mt-1 sm:text-[8px] md:text-[10px] lg:text-xs text-[#0000FE] border border-[#0000FE] rounded-full px-1 lg:px-2 w-full lg:w-[60%] text-center"
          : "mt-1 sm:text-[8px] md:text-[10px] lg:text-xs text-gray-500 border border-gray-500 rounded-full px-1 lg:px-2 w-full lg:w-[60%] text-center",
      style2: progress > 75 ? "bg-[#0000FE]" : "bg-gray-200",
      borderColor: progress > 75 ? "border-[#0000FE]" : "border-gray-500",
      numberColor: progress > 75 ? "border-[#0000FE]" : "border-gray-500",
    },
    {
      label: "STEP 5",
                    ...
                    style={{
                      width:
                        ...
                        step.label === "STEP 3"
                          ? "100%"
                          : step.label === "STEP 4"
                          ? `${Math.min(Math.max(progress - 75, 0) * 4, 100)}%`
                          : "0%",
                    }}
                  ></div>
                </div>
