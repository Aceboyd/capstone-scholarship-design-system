...
const stepDetails = [
  ...
  { label: "STEP 3", imagestep: number3Image, style: "mt-1 text-[10px] sm:text-xs text-xs text-[#0000FE] border border-[#0000FE] rounded-full px-1 sm:px-3", status: "In Progress" },
                  ...
                  return (
                    <React.Fragment key={index}>
                      <div className="flex flex-col  justify-center items-center flex-1 ">
                        ...
                        <div className={`flex justify-center mx-auto items-center w-1 mb-2 h-8 bg-gray-200 rounded-full ${step.style2}`} >
