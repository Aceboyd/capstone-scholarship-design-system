...
const Steps2 = ({ step2Progress }) => {
  const stepDetails = [
    {
      ...
      textStroke: "#0000FE", // Kept for compatibility, but not used for number
      textColor: "#0000FE", // Added to set number color directly
      completed: true,
      progressFill: "100%",
    },
    {
      ...
      status: step2Progress > 0 ? "In Progress" : "Not Started",
      style2: step2Progress > 0 ? "bg-[#0000FE]" : "bg-gray-200",
      borderColor: step2Progress > 0 ? "border-[#CCCFFF]" : "border-gray-400",
      textStroke: step2Progress > 0 ? "#0000FE" : "gray",
      completed: false,
      progressFill: `${step2Progress}%`,
    },
    {
      label: "STEP 3",
  ...
  const appProgress = 25 + step2Progress * 0.2;
      ...
      <div className="mb-20 lg:w-2/3 px-2 lg:px-5 ml-20">
        ...
        <div className="flex items-center mt-2">
          ...
          <span className="ml-2 text-sm text-[#0000FE]">
            {appProgress === 50 ? "Completed" : "In Progress"}
          </span>
        </div>
      </div>
    </div>
