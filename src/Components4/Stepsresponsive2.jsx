...
const Stepsresponsive2 = ({ step2Progress, appStatus, isFillingStep2 }) => {
  // Calculate progress fill for each step
  const stepProgress = [
    100, // Step 1 always completed in this page
    step2Progress, // Step 2 progress from props
    0, // Step 3
    0, // Step 4
    0, // Step 5
  ];
  ...
  const stepDetailsmobile = [
    ...
    },
    {
      ...
      status: isFillingStep2 ? "In Progress" : "Not Started",
      style2: isFillingStep2 ? "bg-[#0000FE]" : "bg-gray-200",
      borderColor: isFillingStep2 ? "border-[#CCCFFF]" : "border-gray-400",
      textStroke: isFillingStep2 ? "#0000FE" : "gray",
    },
    {
      label: "STEP 3",
      title: (
...
export default Stepsresponsive2;