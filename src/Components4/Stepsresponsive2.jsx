...
const stepDetails = [
  ...
  { label: "STEP 2", borderstyle: "border-blue-700", imagestep: number2Image, style: "mt-1 text-[8px] sm:text-xs text-xs text-[#0000FE] border border-[#0000FE] rounded-full px-1 sm:px-3", status: "In Progress" },
