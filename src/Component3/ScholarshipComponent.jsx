...
import fundingIcon from "../assets/image/form/dollar.png";
import calendarIcon from "../assets/image/form/calender.png";
import peopleIcon from "../assets/image/form/contact.png";
import applyArrowIcon from "../assets/image/form/bookmark.png";
    ...
    <div className="bg-gray-50 min-h-screen">
      <div className="mx-auto max-w-7xl px-6 py-12 lg:px-8">
        <div className="flex flex-col md:flex-row gap-6 md:gap-12">
          ...
          <div className="flex-1">
            <section id="overview" className="mt-8 md:mt-20 scroll-mt-24">
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                <span className="bg-blue-100 text-blue-700 px-3 py-1 rounded-md text-sm whitespace-nowrap">
                  Fully Funded
                </span>
                <span className="bg-blue-100 text-blue-700 px-3 py-1 rounded-md text-sm whitespace-nowrap">
                  STEM Research
              ...
              <p className="text-[#000000]/70 text-base md:text-lg mb-3">
                Ghana Education Trust Fund (GETFund)
              </p>
              <div className="flex items-center gap-4 md:gap-6">
                <button
                  className="bg-[#0000FE] text-white px-6 py-2 rounded-md cursor-pointer w-full md:w-auto text-center"
                  onClick={() => handleScroll("apply-section")} // Example: Add scroll to application section
                >
                  Apply Now
                </button>
                <img
          ...
          <aside className="w-full md:w-1/3 mt-6 md:mt-20">
            <div className="flex flex-col gap-4 bg-white p-4 rounded-md shadow-sm">
              <div className="flex items-start gap-3">
                <img src={fundingIcon} alt="Funding Icon" className="w-10 h-10" />
              ...
              <div className="flex items-start gap-3">
                <img src={calendarIcon} alt="Calendar Icon" className="w-10 h-10" />
                <div className="text-gray-800">
                  <div className="text-lg font-semibold">
                    20th March 2025 · {Math.abs(daysLeft)} {daysLeft >= 0 ? "days left" : "days ago"}
                  </div>
                  <div className="text-sm">Application Deadline</div>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <img src={peopleIcon} alt="People Icon" className="w-10 h-10" />
                <div className="text-gray-800">
