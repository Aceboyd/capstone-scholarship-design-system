  ...
  return (
    <footer className="bg-[#000080] text-white py-8 sm:py-12 md:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-5 lg:px-8">
            ...
            <div className="mb-4 sm:mb-6 md:mb-8">
              <div className="flex flex-col sm:flex-row gap-2">
                <input
                  ...
                  className="flex-1 px-3 sm:px-4 py-2 rounded-md text-sm sm:text-base text-gray-900 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 border-none"
                />
                <button
                  type="button"
        ...
        {/* Footer Bottom */}
        <div className="mt-6 sm:mt-8 md:mt-12 pt-4 sm:pt-6 md:pt-8 border-t border-blue-800 text-center text-xs sm:text-sm md:text-base">
